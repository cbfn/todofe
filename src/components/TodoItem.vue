<template>
  ...
  <span class="list-group-actions">
    ...
    <a href="javascript:void(0);" v-on:click.prevent="this.$parent.removeTodo(todolist)" title="Remove {{todolist.attributes.title}}?" v-else><i class="fa fa-trash fa-lg"></i></a>
  </span>
</template>
